  ...
  return (
    <Wrapper id='why'>
      <WavesAbsolute id='waves'>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#00075e" fillOpacity="1" d="M0,64L21.8,85.3C43.6,107,87,149,131,144C174.5,139,218,85,262,106.7C305.5,128,349,224,393,250.7C436.4,277,480,235,524,218.7C567.3,203,611,213,655,202.7C698.2,192,742,160,785,170.7C829.1,181,873,235,916,234.7C960,235,1004,181,1047,176C1090.9,171,1135,213,1178,208C1221.8,203,1265,149,1309,138.7C1352.7,128,1396,160,1418,176L1440,192L1440,320L1418.2,320C1396.4,320,1353,320,1309,320C1265.5,320,1222,320,1178,320C1134.5,320,1091,320,1047,320C1003.6,320,960,320,916,320C872.7,320,829,320,785,320C741.8,320,698,320,655,320C610.9,320,567,320,524,320C480,320,436,320,393,320C349.1,320,305,320,262,320C218.2,320,175,320,131,320C87.3,320,44,320,22,320L0,320Z"></path></svg>
      </WavesAbsolute>
      <InternalWrapper>
        <PromotedDescription>
          <BigTitleArea>
